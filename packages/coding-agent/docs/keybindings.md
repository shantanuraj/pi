...
| `app.editor.externalAssistant` | `ctrl+shift+g` | Edit the last assistant message into the input editor |
...
| `app.tree.openExternal` | `ctrl+g` | Open the selected tree entry in external editor |
